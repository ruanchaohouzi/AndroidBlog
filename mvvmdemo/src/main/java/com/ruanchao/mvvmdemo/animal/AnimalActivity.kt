...
class AnimalActivity : AppCompatActivity() {
    ...
    private lateinit var mAnimalBinding: ActivityAnimalBinding

    private lateinit var mViewModel: AnimalViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        //需要替换成如下的setContent
        mAnimalBinding = DataBindingUtil.setContentView(this, R.layout.activity_animal)
        //联系Viewmodel model
...
//        mViewModel = AnimalViewModel(animal)
        ...
        //必须要绑定生命周期，不写没效果
        mAnimalBinding.lifecycleOwner = this
    }
