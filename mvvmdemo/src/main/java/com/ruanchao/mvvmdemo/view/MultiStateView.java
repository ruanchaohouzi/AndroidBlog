...
public class MultiStateView extends FrameLayout {
     ...
     *
     * @param state The with to return the view for
     * @return The {@link View} associated with the , null if no view is present
     */
    @Nullable
     ...
     *
     * @param state The { com.kennyc.view.MultiStateView.ViewState} to set {@link MultiStateView} to
     */
    ...
    /**
     * Shows the {@link View} based on the { com.kennyc.view.MultiStateView.ViewState}
     */
    ...
    /**
     * Sets the {@link View} for the given { com.kennyc.view.MultiStateView.ViewState}
     *
     * @param view  The {@link View} to use
     * @param state The { com.kennyc.view.MultiStateView.ViewState} to set
     */
