...
object PreferencesUtil {
    ...
    private val prefs: SharedPreferences by lazy { MainApplication.context.getSharedPreferences(name, Context.MODE_PRIVATE) }
    ...
    fun getSet(key: String): MutableSet<String>? {
        val stringSet = prefs.getStringSet("cookie", null)
        if (stringSet != null) {
            stringSet as HashSet
            return stringSet
        }
        return null
    }

    fun saveSetString(key: String, value: MutableSet<String>?) {
